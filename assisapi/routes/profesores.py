...
from assisapi.model.dbassis import profesores, db
...
def get_profesores():
    all_profesores = profesores.query.all()
...
def get_profesor(id):
    profesor_id = profesores.query.get(id)
...
def create_profesor():
    ...
    new_profesor = profesores(nombre, apellidos, no_trabajador)
...
def update_profesor(id):
    profesor_update = profesores.query.get(id)
    nombre = request.json['nombre']
    apellidos = request.json['apellidos']
    no_trabajador= request.json['no_trabajador']
...
def delete_profesor(id):
    profesor_delete = profesores.query.get(id)
